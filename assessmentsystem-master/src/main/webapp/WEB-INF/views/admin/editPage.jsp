    ...
    <div class="row">
        ...
        <div class="col-lg-6 mycont">
            ...
            <form:form
                ...
                <div class="form-group">
                    <form:input type="text" path="login" class="form-control" value=" " placeholder="Логин" id="login"/>
                </div>
                <div class="form-group">
                    <form:input type="password" path="password" class="form-control" value=" " placeholder="Пароль" id="password"/>
                </div>
                <div class="form-group">
